...
class Character {
  ...
  getInfo = () => `This is a ${this.type} character named ${this.name}.`
...
class Player extends Character {
  ...
  defend(oppAttackLevel) {
    this.healthLevel -= oppAttackLevel;
    if (this.healthLevel > 0) {
      return (
        {
          attackStrength: oppAttackLevel,
...
fireSpitter.addSuperPower('eating')
